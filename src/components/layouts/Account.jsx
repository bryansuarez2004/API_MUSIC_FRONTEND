...
const Options = ({modeAccount}) => {
  ...
  return (
    <div className={ `${modeAccount ? 'top-[40px] opacity-100' : ' top-[-150px] opacity-0'}   bg-tertiary absolute right-0 p-1 rounded-md grid w-[150px] gap-2 text-white transition-all duration-500`}>
